...
- [Monooki](https://github.com/kaskajp/monooki)
Home Inventory Management System.

- [4AM](https://github.com/kaskajp/4am)
A macOS Music Player built for libraries on SMB shares.

- [FFTPU](https://github.com/kaskajp/fftpu)
FTP Upload Menu Bar Tool.

- [Furigana in HTML](/furigana/)
A guide for how to use furigana in HTML with ruby tags.
